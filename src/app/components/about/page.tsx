    ...
    <section>
      <div className="flex flex-col md:flex-row w-[90%] m-auto my-5 md:my-14 md:gap-y-8">
        ...
        <div className="flex flex-col justify-around md:w-[60%] md:h-[80%] lg:gap-y-8 items-center md:items-start">
          <div className="relative border-4 border-green-900 h-60 md:h-72 w-[80%] md:w-[80%] lg:h-96">
            <Image
          ...
          <div className="md:block hidden relative border-4 border-green-900 h-60 w-[60%] lg:h-72 md:w-[60%]">
            <Image
