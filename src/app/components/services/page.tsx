  ...
  return (
    <div className='bg-custom-green md:rounded-tl-[100px] rounded-br-[50px] rounded-tl-[50px] md:rounded-br-[100px] w-full mx-auto my-20 py-16'>
      ...
      <div className='grid grid-cols-3 grid-rows-2 gap-1 mx-auto md:w-[80%] w-[90%]'>
        ...
        <div className='col-span-2 row-span-2 relative'>
          <img
            className={`w-full h-[30vh] md:h-[400px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 0 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/commercial-design.jpg"
            alt="Commercial Design"
            onClick={() => setSelectedImage(selectedImage === 0 ? null : 0)} // Update selection
          />
        ...
        <div className='col-span-1 row-span-1 relative'>
          <img
            className={`w-full h-[15vh] md:h-[200px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 1 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/home-staging.webp"
            alt="Home Staging"
            onClick={() => setSelectedImage(selectedImage === 1 ? null : 1)} // Update selection
          />
        ...
        <div className='col-span-1 row-span-1 relative'>
          <img
            className={`w-full h-[15vh] md:h-[200px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 2 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/furniture-selection.jpeg"
            alt="Furniture Selection"
            onClick={() => setSelectedImage(selectedImage === 2 ? null : 2)} // Update selection
          />
        ...
        <div className='col-span-1 row-span-1 relative'>
          <img
            className={`w-full h-[15vh] md:h-[200px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 3 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/space-planning.jpg"
            alt="Space Planning"
            onClick={() => setSelectedImage(selectedImage === 3 ? null : 3)} // Update selection
          />
        ...
        <div className='col-span-1 row-span-1 relative'>
          <img
            className={`w-full h-[15vh] md:h-[200px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 4 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/residential-design.jpg"
            alt="Residential Design"
            onClick={() => setSelectedImage(selectedImage === 4 ? null : 4)} // Update selection
          />
        ...
        <div className='col-span-1 row-span-1 relative'>
          <img
            className={`w-full h-[15vh] md:h-[200px] rounded-lg border-2 border-white object-cover transition-opacity duration-300 ${selectedImage === 5 ? 'opacity-30' : 'opacity-100'}`} // Change opacity if selected
            src="/images/color-consultation.jpg"
            alt="Color Consultation"
            onClick={() => setSelectedImage(selectedImage === 5 ? null : 5)} // Update selection
          />
